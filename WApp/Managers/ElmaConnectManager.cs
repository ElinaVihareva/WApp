                    ...
                    foreach (var dictC in dictB)
                    {
                        ...
                        foreach (var param in params1)
                        {
                            ...
                            if (p1.ContainsKey("Name"))
                            {
                                ...
                                {
                                    instance.endDate = DateTime.Parse((string)p1["Value"]);
                                }
                            }
                            if (p1.ContainsKey("Name"))
                            {
                                ...
                                {
                                    instance.status = long.Parse((string)p1["Value"]);
                                }
                            }
                            if (p1.ContainsKey("Name"))
                            {
                                var name = p1["Name"];
                                if (name.Equals("elementUid"))
                                {
                                    instance.elementUid = Guid.Parse((string)p1["Value"]);
                                }
                            }
                            instance.elmaId = 0;
            ...
            typeUid, eqlQuery, limit, offset, sort, filterProviderUid, filterProviderData, filter, ServerName);
                ...
                if (dictB != null)
                {
                    foreach (var dictC in dictB)
                    {
                        ...
                        var params1 = items as object[];
                        // Создать объект контекста
                        CodeFirst.Model.WorkflowTrackingItem instance = new CodeFirst.Model.WorkflowTrackingItem();
                        ...
                        CodeFirst.SampleContext context = new CodeFirst.SampleContext();
                        // Вставить данные в таблицу 
                        context.WorkflowTrackingItem.Add(instance);
                        // Сохранить изменения в БД
                        context.SaveChanges();
                    }
                }
            ...
            typeUid, eqlQuery, limit, offset, sort, filterProviderUid, filterProviderData, filter, ServerName);
                ...
                if (dictB != null)
                {
                    foreach (var dictC in dictB)
                    {
                        ...
                        var params1 = items as object[];
                        // Создать объект контекста
                        CodeFirst.Model.WorkflowProcess instance = new CodeFirst.Model.WorkflowProcess();
                        ...
                        foreach (var param in params1)
                        {
                            ...
                            if (p1.ContainsKey("Name"))
                            {
                                ...
                                {
                                    instance.header = long.Parse((string)p1["Value"]);
                                }
                            }
                            if (p1.ContainsKey("Name"))
                            {
                                ...
                                {
                                    instance.versionNumber = long.Parse((string)p1["Value"]);
                                }
                            }
                            instance.elmaId = 0;
                        ...
                        context.WorkflowProcess.Add(instance);
                        rez++;
                        // Сохранить изменения в БД
                        context.SaveChanges();
            ...
            typeUid, eqlQuery, limit, offset, sort, filterProviderUid, filterProviderData, filter, ServerName);
                ...
                if (dictB != null)
                {
                    foreach (var dictC in dictB)
                    {
                        ...
                        var params1 = items as object[];
                        // Создать объект контекста
                        CodeFirst.Model.TaskBase instance = new CodeFirst.Model.TaskBase();
                        instance.endWorkDate = DateTime.Now;
                        instance.startDate = DateTime.Now;
                        foreach (var param in params1)
                        {
                            var p1 = param as Dictionary<string, object>;
                            ...
                            if (p1.ContainsKey("Name"))
                            {
                                ...
                                if (name.Equals("EndDate"))
                                {
                                    instance.endWorkDate = DateTime.Parse((string)p1["Value"]);
                                }
                            }
                            if (p1.ContainsKey("Name"))
                            {
                                ...
                                {
                                    instance.subject = ((string)p1["Value"]);
                                }
                            }
                            if (p1.ContainsKey("Name"))
                            {
                                ...
                                {
                                    instance.executor = long.Parse((string)p1["Value"]);
                                }
                            }
                            if (p1.ContainsKey("Name"))
                            {
                                var name = p1["Name"];
                                if (name.Equals("workflowBookmark"))
                                {
                                    instance.workflowBookmark = long.Parse((string)p1["Value"]);
                                }
                            }
